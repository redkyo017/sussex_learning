...
required_snippets = [
    "Measures the difference in gravitational acceleration",
    "Vibration is common to both atom clouds",
    ...
    "Know what is under the ground before breaking it",
    "Records are often wrong",
    "An answer rather than a caveat",
    "We tell contractors what lies under the ground",
    "A survey service rather than an instrument sale",
    "The sensor responds to density contrast",
    "Priced by the day against the 29-times multiplier",
    "A university physics group for the licence",
    "Paid field trials with lead users",
    "Depth-resolved subsurface maps, with stated uncertainty",
    "Repeat rather than one-off, because difficult sites recur",
    "Primary: UK utility asset owners and tier-1 contractors",
    "The licensed interferometry IP matters less",
    "Direct technical selling into a handful of asset owners",
    "People first: physicists and field engineers",
    "Day rates for surveys, which is how this industry already buys",
]
